...
// app.post("/countcomments", async (req, res) => {
//     try{
//         const [[{commentcount}]] = await pool.execute("SELECT COUNT(*) AS commentcount FROM comments WHERE post_id = 19");
//         res.status(200).send({sucess: true, commentcount});
//     }catch(err){
